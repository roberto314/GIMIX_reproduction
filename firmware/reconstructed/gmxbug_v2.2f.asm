...
DATRAM  EQU     $FFF0     DAT memory area
*UPCASE  EQU     $E421
...
*Init DAT memory - map all tasks to point to
*00000-0DFFF and FE000-FFFFF

RESETI  LDB    #15              set up for 15 tasks
RESET1  STB    TSR              select a task
        LDX    #DATRAM
        CLRA
RESET2  STA    ,X+             0000-DFFF to bank 0
        INCA
        CMPA   #14
        BNE    RESET2
        ORA    #$F0             E000-EFFF to bank F
        STA    ,X+
        INCA
        STA    ,X+
        DECB
        BPL    RESET1           repeat for tasks through task 0
        LBRA   COLD             go to monitor cold start
...
RESERV  FDB    0000            reserved for future use
SWI3    FDB    SW3JMP
SWI2    FDB    SW2JMP
FIRQ    FDB    FRQJMP
IRQ     FDB    IRQJMP
